...
const PhotoDetails = (props) => {
  ...
  console.log("PhotoDetailsComponent.native\n");
  //console.log(props.photos);

  return (
    <View style={styles.container}>
      <View style={styles.containerphotos}>
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={true} persistentScrollbar={true} style={styles.flatlistfltr}>
          {
